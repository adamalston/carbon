...
export interface SliderProps
  ...
  /**
   * Specify whether the Slider is in warning state
   */
  warn?: boolean;

  /**
   * Provide the text that is displayed when the Slider is in warning state
   */
  warnText?: ReactNode;
}
...
const Slider = (props: SliderProps) => {
  ...
  /**
   * Throttles calls to `onDragRef` by limiting events to being processed at

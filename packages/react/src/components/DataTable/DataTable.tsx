...
export interface DataTableProps<RowType, ColTypes extends any[]>
  ...
  overflowMenuOnHover?: boolean;
  radio?: boolean;
  // TODO: Any reason to keep this prop since it matches `children`? I'm
  // wondering if it should be deprecated.
  render?: (
    renderProps: DataTableRenderProps<RowType, ColTypes>
  ) => ReactElement;
...
/**
 * TODO: Is everything in this comment still accurate? If not, figure out if it
 * should be updated of deleted.
 *
...
// TODO: Should these namespaced components and properties be removed in a
// future release? It happened for v11:
